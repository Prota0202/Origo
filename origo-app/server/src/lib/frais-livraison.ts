/** Franco de port B2B : au-dessus du seuil, 0 € ; sinon forfait HT. */
export const SEUIL_FRANCO_HT = 150
export const FRAIS_LIVRAISON_HT = 10

export function fraisLivraisonHT(sousTotalArticlesHT: number) {
...
export function normaliserCgv(texte: string) {
